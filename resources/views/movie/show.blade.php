...
@section('content')
    <div class="movie-info border-b border-gray-600">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{$movie['poster_path']}}" alt="Lexi" class="hover:opacity-75 transition ease-in-out duration-250" alt="" srcset="" class="w-64 md:w-96">
            <div class="md:ml-24">
                ...
                <div class="mt-12">
                    <h4 class="text-white font-semibold">Feautred Cast</h4>
                    <div class="flex mt-4"> 
                            ...
                            <div class="bg-gray-900 rounded">
                                <div class="flex justify-end pr-4 pt-2">
                                    <button
                                        ...
                                        class="text-3xl leading-none hover:text-gray-600">&times;
                                    </button>
                                </div>
                ...
                @foreach ($movie['cast'] as $cast)
                    <div class="mt-8">
                        <a href="/actors/{{$cast['id']}}">
                            <img src="{{'https://image.tmdb.org/t/p/w500/'.$cast['profile_path']}}" alt="{{$cast['name']}}" class="hover:opacity-75 transition ease-in-out duration-250">
                            {{$cast['name']}}
                        </a>
